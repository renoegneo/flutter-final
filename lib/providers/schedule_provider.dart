...
//
// Provider — это "хранитель состояния" приложения.
// Состояние (state) — текущие данные: список событий, выбранная дата и т.д.
// Когда данные меняются — экраны автоматически перерисовываются.
//
// ChangeNotifier — базовый класс, который умеет "уведомлять" виджеты об изменениях.
